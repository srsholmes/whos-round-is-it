...
},{"../constants/constants":191,"reflux":176}],180:[function(require,module,exports){
'use strict';

var components = require('./components');

},{"./components":181}],181:[function(require,module,exports){
'use strict';

var app = require('./web/appContainer');

},{"./web/appContainer":189}],182:[function(require,module,exports){
'use strict';
...
var Reflux = require('reflux');
var Actions = require('../../actions/actions');var Store = require('../../stores/store');
...
var App = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      { className: this.state.drink + " container" },
      React.createElement(_.EntryQuestion, this.state),
      React.createElement(_.Game, this.state)
    );
  }
});
...
},{"../../actions/actions":179,"../../stores/store":194,"./":190,"react":159,"reflux":176}],183:[function(require,module,exports){
'use strict';
...
var Buttons = React.createClass({
  ...
  onChooseLad: function onChooseLad() {
    window.scroll(0, 0);
    Actions.chooseLad();
  },

  onClearLads: function onClearLads() {
    Actions.clearLads();
  },

  onMixDrinks: function onMixDrinks() {
    Actions.mixDrinks();
  },
  ...
  render: function render() {
    ...
    var chooseButton = undefined,
        clearButton = undefined,
        mixerButton = undefined,
        newRoundButton = undefined;
    var drink = this.props.drink;

    if (people.length > 0) {
      chooseButton = React.createElement(
        'button',
        { className: 'whos-round-btn waves-effect waves-light btn', onClick: this.onChooseLad },
        _constantsConstants.PHRASES[drink].chooseButton
      );
      clearButton = React.createElement(
        'button',
        { className: 'whos-round-btn waves-effect waves-light btn', onClick: this.onClearLads },
        'Clear people'
      );
      mixerButton = React.createElement(
        'button',
        { className: 'whos-round-btn waves-effect waves-light btn', onClick: this.onMixDrinks },
        'Mix up the drinks'
      );
    }

    if (people.length === 0 && this.props.group.length > 0) {
      newRoundButton = React.createElement(
        'button',
        { className: 'whos-round-btn waves-effect waves-light btn', onClick: this.onNewRound },
        'Another round'
      );
    }
...
},{"../../actions/actions":179,"../../constants/constants":191,"react":159,"reflux":176}],184:[function(require,module,exports){
'use strict';
...
var Person = React.createClass({
  ...
  render: function render() {
    var drinkIcon = new Image();
    var drink = this.props.drink;
    var person = this.props.chosenPerson;
    ...
    return React.createElement(
      ...
      React.createElement(
        'span',
        { className: 'beer-icon left' },
        React.createElement('img', { src: drinkIcon.src })
      ),
      React.createElement(
        'span',
        { className: 'beer-icon right' },
        React.createElement('img', { src: drinkIcon.src })
      )
    );
  }
...
},{"react":159,"reflux":176}],185:[function(require,module,exports){
'use strict';
...
var EntryQuestion = React.createClass({
  displayName: 'EntryQuestion',

  render: function render() {
    var drink = this.props.drink;
    var title = (0, _modules.chooseRandom)(_constantsConstants.PHRASES.Entry.title);
    if (drink) return React.createElement('div', null);

    var entryButtons = _constantsConstants.DRINKS.map(function (drink, i) {
      return React.createElement(
        'button',
        { onClick: Actions.chooseDrink.bind(null, i), className: drink + ' whos-round-btn choose-drink-btn waves-effect waves-light btn' },
        drink
      );
    }, this);
...
exports['default'] = EntryQuestion;
module.exports = exports['default'];

},{"../../actions/actions":179,"../../constants/constants":191,"../../modules":193,"react":159,"reflux":176}],186:[function(require,module,exports){
'use strict';
...
var Game = React.createClass({
  ...
  newNameKeyDown: function newNameKeyDown(e) {
    if (event.type === 'react-blur' || e.which === 13) {
      e.preventDefault();
      var val = this.refs.roundField.value.trim();
      if (val) {
        if (/[ ,]+/.test(val)) {
          var arr = val.split(/[ ,]+/);
          arr.map(function (i, el) {
            Actions.addName(i);
          });
        } else {
          Actions.addName(val);
  ...
  textShrink: function textShrink() {
  ...
  render: function render() {
    if (this.props.drink === null) {
      ...
      return React.createElement(
        'div',
        null,
        React.createElement(_.Person, this.props),
        React.createElement(_.People, this.props),
        React.createElement(
          'div',
          { className: 'input-field col s12' },
          React.createElement('input', { ref: 'roundField',
            className: 'new-round validate',
            placeholder: _constantsConstants.PHRASES[this.props.drink].placeholder,
            onKeyDown: this.newNameKeyDown,
            onBlur: this.newNameKeyDown,
            autoFocus: true,
            id: 'names', type: 'text' })
        ),
        React.createElement(_.Buttons, this.props)
      );
    }
  }
});
...
},{"../../actions/actions":179,"../../constants/constants":191,"./":190,"react":159,"reflux":176}],187:[function(require,module,exports){
'use strict';
...
var People = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    var drink = this.props.drink;
    this.title = _constantsConstants.PHRASES[drink].title;
  },
  ...
  componentWillUpdate: function componentWillUpdate(nextProps, nextState) {
    ...
    if (nextProps.chosenPerson !== this.props.chosenPerson) {
      if (nextProps.people.length === 0 && nextProps.chosenPerson !== null) {
        this.title = _constantsConstants.PHRASES[drink].endTitle;
      } else {
        this.title = (0, _modules.chooseRandom)(_constantsConstants.PHRASES[drink].continueRound);
      }
    }
  },

  render: function render() {
    var people = this.props.people.join(', ');
    var person = this.props.chosenPerson;
    return React.createElement(
      'div',
      { className: 'people' },
      React.createElement(
        'h3',
        { className: person == null ? 'title' : 'sub-title' },
        this.title
      ),
      React.createElement(
        'h5',
...
},{"../../constants/constants":191,"../../modules":193,"react":159,"reflux":176}],188:[function(require,module,exports){
'use strict';
    ...
    if (person) {
      return React.createElement(
        ...
        React.createElement(
          'h2',
          { className: 'name' },
          React.createElement(_.DrinkPic, this.props),
          React.createElement(
            'span',
...
},{"./":190,"react":159,"reflux":176}],189:[function(require,module,exports){
'use strict';
...
_reactDom2['default'].render(_react2['default'].createElement(
  'div',
  null,
  _react2['default'].createElement(_.App, null)
), document.querySelector('[app]'));

},{"./":190,"babel-runtime/helpers/interop-require-default":1,"react":159,"react-dom":3}],190:[function(require,module,exports){
'use strict';
...
exports.App = _interopRequire(_AppJsx);

var _PersonJsx = require('./Person.jsx');

exports.Person = _interopRequire(_PersonJsx);

var _PeopleJsx = require('./People.jsx');

exports.People = _interopRequire(_PeopleJsx);

var _ButtonsJsx = require('./Buttons.jsx');

exports.Buttons = _interopRequire(_ButtonsJsx);

var _GameJsx = require('./Game.jsx');

exports.Game = _interopRequire(_GameJsx);

var _EntryQuestionJsx = require('./EntryQuestion.jsx');

exports.EntryQuestion = _interopRequire(_EntryQuestionJsx);

var _DrinkPicJsx = require('./DrinkPic.jsx');

exports.DrinkPic = _interopRequire(_DrinkPicJsx);

},{"./App.jsx":182,"./Buttons.jsx":183,"./DrinkPic.jsx":184,"./EntryQuestion.jsx":185,"./Game.jsx":186,"./People.jsx":187,"./Person.jsx":188,"babel-runtime/helpers/interop-require":2}],191:[function(require,module,exports){
'use strict';

var LOCAL_STORAGE_KEY = 'whosRoundIsIt';
var DRINKS = ['beer', 'wine', 'shots', 'cocktails', 'champagne'];
...
var _chooseRandom = require('./chooseRandom');

var _chooseRandom2 = _interopRequireDefault(_chooseRandom);

exports['default'] = {
	chooseRandom: _chooseRandom2['default']
};
module.exports = exports['default'];

},{"./chooseRandom":192,"babel-runtime/helpers/interop-require-default":1}],194:[function(require,module,exports){
'use strict';
...
var Store = Reflux.createStore({
  ...
  _setupLocalStorage: function _setupLocalStorage() {
    var localStorageItem = localStorage.getItem(_constantsConstants.LOCAL_STORAGE_KEY);
    localStorageItem === null || JSON.parse(localStorageItem).dataValid !== true ? localStorage.setItem(_constantsConstants.LOCAL_STORAGE_KEY, JSON.stringify(this.contents)) : this.contents = JSON.parse(localStorageItem);
  },

  _updateLocalStorage: function _updateLocalStorage(obj) {
    localStorage.setItem(_constantsConstants.LOCAL_STORAGE_KEY, JSON.stringify(obj));
  },

  onChooseDrink: function onChooseDrink(i) {
    this.contents.drink = _constantsConstants.DRINKS[i];
    this._updateLocalStorage(this.contents);
    this.trigger(this.contents);
  },

  onAddName: function onAddName(name) {
  ...
  onChooseLad: function onChooseLad() {
    ...
    var group = this.contents.group;
    var num = Math.floor(people.length * Math.random());
    var choice = people[num];
    people.splice(num, 1);
  ...
  onNewRound: function onNewRound() {
    this.contents.people = JSON.parse(localStorage.getItem(_constantsConstants.LOCAL_STORAGE_KEY)).group;
...
},{"../actions/actions":179,"../constants/constants":191,"reflux":176}]},{},[180]);
