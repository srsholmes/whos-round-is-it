...
},{"./components":365,"babelify/polyfill":185,"react":341,"whatwg-fetch":361}],2:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _=require("./"),React=require("react"),Reflux=require("reflux"),Actions=require("../actions/actions"),Store=require("../stores/store"),App=React.createClass({displayName:"App",mixins:[Reflux.connect(Store)],newNameKeyDown:function(e){if(13===event.keyCode){e.preventDefault();var val=React.findDOMNode(this.refs.roundField).value.trim();val&&(Actions.addName(val),React.findDOMNode(this.refs.roundField).value="")}},onChooseLad:function(){window.scroll(0,0),Actions.chooseLad()},onClearLads:function(){Actions.clearLads()},textShrink:function(){var textDiv=document.querySelector(".named-person"),textContainer=document.querySelector(".name"),textSpan=document.querySelector(".chosen-name");if(textSpan)for(textSpan.style.fontSize="86px";textContainer.offsetWidth>textDiv.offsetWidth-120;)textSpan.style.fontSize=parseInt(textSpan.style.fontSize)-1+"px"},componentDidUpdate:function(){this.textShrink()},render:function(){var button=void 0,clearButton=void 0,ladTitle=void 0,ladTitles=void 0,person=this.state.chosenPerson,people=this.state.people.join(", ");return ladTitle="Who's a lad?",ladTitles=["One more round?","Another?","Still a lad?","How about another?","Go on!","Feeling refreshed?","Pint?"],person&&(ladTitle=ladTitles[Math.floor(Math.random()*ladTitles.length)]),people.length>0&&(button=React.createElement("button",{className:"whos-round-btn waves-effect waves-light btn blue darken-3",onClick:this.onChooseLad},"Choose a lad"),clearButton=React.createElement("button",{className:"whos-round-btn waves-effect waves-light btn blue darken-3",onClick:this.onClearLads},"Get rid of them")),React.createElement("div",{className:"container"},React.createElement("div",null,React.createElement(_.Person,{name:person}),React.createElement("div",{className:"people"},React.createElement("h3",{className:null==person?"title":"sub-title"},ladTitle),React.createElement("h5",{className:"the-lads"},people)),React.createElement("div",{className:"input-field col s12"},React.createElement("input",{ref:"roundField",className:"new-round validate",placeholder:"Whack in the lads names...",onKeyDown:this.newNameKeyDown,autoFocus:!0,id:"names",type:"text"})),React.createElement("div",{className:"buttons"},React.createElement("div",{className:"btn-wrap"},button),React.createElement("div",{className:"btn-wrap"},clearButton))))}});exports["default"]=App,module.exports=exports["default"];


},{"../actions/actions":362,"../stores/store":366,"./":365,"react":341,"reflux":358}],364:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var React=require("react"),Reflux=require("reflux"),Person=React.createClass({displayName:"Person",render:function(){var beerIcon=new Image;beerIcon.src="/assets/img/beer-emoji.png";var person=this.props.name;return person?React.createElement("div",{className:"named-person"},React.createElement("h4",null,"It's"),React.createElement("h2",{className:"name"},React.createElement("span",{className:"beer-icon"},React.createElement("img",{src:beerIcon.src})),React.createElement("span",{className:"chosen-name"},person,"'s"),React.createElement("span",{className:"beer-icon"},React.createElement("img",{src:beerIcon.src}))),React.createElement("h4",null,"round!"),React.createElement("span",{className:"beer-icon breaker"},React.createElement("img",{src:beerIcon.src}))):React.createElement("div",null)}});exports["default"]=Person,module.exports=exports["default"];


},{"react":341,"reflux":358}],365:[function(require,module,exports){
"use strict";var _interopRequire=require("babel-runtime/helpers/interop-require")["default"];Object.defineProperty(exports,"__esModule",{value:!0});var _AppJsx=require("./App.jsx");exports.App=_interopRequire(_AppJsx);var _PersonJsx=require("./Person.jsx");exports.Person=_interopRequire(_PersonJsx);


},{"./App.jsx":363,"./Person.jsx":364,"babel-runtime/helpers/interop-require":2}],366:[function(require,module,exports){
